...
public partial class EquiposViewModels : ObservableObject
{
    ...
    public async Task EditarEquipo(EquiposModels equipo)
    {
        ...
        await Shell.Current.GoToAsync($"/equipo?Id={equipo.Id}&Nombre={equipo.Nombre}&Apellido={equipo.Apellido}", false);
    ...
    public async Task AddNew()
    {
        ...
        await Shell.Current.Navigation.PushAsync(new equipo(), false);
    }
